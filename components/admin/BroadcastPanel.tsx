...
import { Upload, Send, CheckCircle2, XCircle, MinusCircle, Loader2, Trash2, History, RefreshCw } from "lucide-react";
...
/**
 * The outreach broadcast tool, rendered as a tab inside /admin. The admin
 * page owns authentication and passes the already-verified password down —
 * this panel just forwards it on each API call.
 */
export function BroadcastPanel({ password }: { password: string }) {
  ...
  return (
    <div style={{ maxWidth: "46rem" }}>
      ...
      {/* History dashboard, everyone this tool has ever emailed */}
      {showHistory && (
