    ...
    <>
      <style>{`
        .bubble-panel {
          ...
          box-shadow: 0 24px 60px rgba(74,107,88,0.14), 0 4px 16px rgba(74,107,88,0.06);
        ...
        .bubble-btn {
          ...
          z-index: 9001; box-shadow: 0 8px 24px rgba(74,107,88,0.30);
          transition: transform 0.2s, box-shadow 0.2s;
        }
        .bubble-btn:hover { transform: scale(1.08); box-shadow: 0 12px 32px rgba(74,107,88,0.38); }
        .bubble-field {
        ...
        .mode-tab.inactive { background: rgba(74,107,88,0.04); color: var(--c-ink-muted); }
        .mode-tab.inactive:hover { background: rgba(74,107,88,0.08); }
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "1.25rem 1.5rem" }}>
            {submitted ? (
              <div style={{ textAlign: "center", padding: "2rem 0" }}>
                <div style={{ width: "2.5rem", height: "2.5rem", borderRadius: "50%", background: "rgba(74,107,88,0.08)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 0.75rem" }}>
