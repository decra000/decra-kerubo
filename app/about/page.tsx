...
function PaperTile({ paper }: { paper: Paper }) {
  return (
    <div style={{
      ...
      {/* faint grain / vignette to match the editorial dusk-photo feel */}
      <div style={{
        position: "absolute", inset: 0,
          ...
          {PAPERS.map((paper, i) => (
            <article
              ...
              style={{
                ...
                opacity: vis ? 1 : 0,
                transform: vis ? "none" : "translateY(22px)",
                transition: `opacity 0.7s cubic-bezier(0.16,1,0.3,1) ${0.08 + i * 0.07}s, transform 0.7s cubic-bezier(0.16,1,0.3,1) ${0.08 + i * 0.07}s`,
              }}
            >
              <button
